...
/*
 * We're about to move all the items between to a pair of new pages.
 * Find the item that balances the space consumed by items in either
 * page.  We move the mid (and possibly only) item to the right page.
 */
